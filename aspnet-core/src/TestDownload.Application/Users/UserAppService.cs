...
namespace TestDownload.Users
{
    ...
    public class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedResultRequestDto, CreateUserDto, UserDto>, IUserAppService
    {
        ...
        public void GetDowloadTest()
        {
            ExportHelper.CreateWorkbook()
                .CreateSheeet("template", new string[] { "name", "class", "identity", "gender" })
                .WriteToResponse2(_contextAccessor.HttpContext, "template");
        }
